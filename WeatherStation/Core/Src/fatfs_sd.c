/**
 * @file 		FATFS_SD.c
 * @brief 		This file contains the functions for handling SD card operations
 * @date		10-Jul-2019
 * @author      Controllerstech
 *
 * It is responsible for initialization, read/write operations, and utility functions for communication
 * and buffer manipulation. It utilizes the HAL library for STM32 and FatFs module
 * and for file system operations on SD card.
 *
 */

/** @defgroup Storage
 *  This group contains files for data storage and filesystem management.
 *  @{
 */
...
extern UART_HandleTypeDef huart2;			/*Uart for pc communication*/
...
/**
 * @brief Calculates the size of a buffer.
 * @param buf The buffer whose size needs to be calculated.
...
/**
 * @brief Saves sensor and weather data to the SD card file.
 * @param fil Pointer to the file object.
 * @param aht_temp Temperature value from AHT sensor.
 * @param aht_humid Humidity value from AHT sensor.
 * @param max_temp Maximum temperature from weather data.
 * @param min_temp Minimum temperature from weather data.
